...
public abstract class AbstractPoiDAO<T> implements IDao<T> {
	...
	//private static final String FILE__NAME = System.getProperty("user.home") + "/dao_memory/bdd_memory.xlsx";
	private static final String FILE__NAME = System.getProperty("user.dir") + "/dao_memory/bdd_memory.xlsx";
